...
TextStyle headerPrimaryTextStyle1 =
    TextStyle(color: Colors.black, fontSize: 14);
TextStyle headerPrimaryTextStyle2 =
    TextStyle(color: Colors.black, fontSize: 12);

TextStyle headerSecondaryTextStyle1 =
    TextStyle(color: Colors.grey[500], fontSize: 15);
TextStyle headerSecondaryTextStyle2 =
...
Widget DashboardCards(
  ...
  return Container(
    height: 100,
    decoration: boxDecoration(
        backGroundColor: color, radius: 10, spreadRadius: 2, blurRadius: 4),
    child: Padding(
...
String getLoanStatus(int status) {
  switch (status) {
    case 0:
      return "Submitted";
      break;
...
Color getLoanStatusColor(int status) {
  switch (status) {
    case 0:
...
double GetPaddingFromScreenSize(double screenSize) {
  if (screenSize < 800)
    ...
    return 50;
  else if (screenSize > 1000) return 4;
}
