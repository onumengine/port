        ...
        body: SafeArea(
          child: BlocBuilder<HomeBloc, AppointmentState>(
            ...
            if (state is BookedState) {
              List approvedAppointments = state.otherSchedules
                  .where((element) => element["action"] == "Approved")
                  .toList();
              ...
              return TabBarView(
                children: [
                  Center(
                    child: (state.todaysSchedules.length == 0)
                        ...
                        : ListView.separated(
                            padding: EdgeInsets.symmetric(
                              horizontal:
                                  _getHorizontalPadding(screenSize.width),
                              vertical: 24,
                            ),
                            itemBuilder: (context, index) {
                              return AppointmentCard(
                                organizationName: state.todaysSchedules
                                    .elementAt(index)["org_name"],
                                startTime: state.todaysSchedules
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => DetailsScreen(
                                        appointment: state.todaysSchedules
                                            .elementAt(index),
                                      ),
                                    ),
                                  );
                  ...
                  Center(
                    child: (approvedAppointments.length == 0)
                        ? EmptyAppointmentsComponent(
                            instructionalText:
                                "You dont have any appointments for other days",
                          )
                        : ListView.separated(
                            padding: EdgeInsets.symmetric(
                              horizontal:
                            ...
                            itemBuilder: (context, index) {
                              return AppointmentCard(
                                organizationName: approvedAppointments
                                    .elementAt(index)["org_name"],
                                startTime: approvedAppointments
                                    .elementAt(index)["time"],
                                approvalStatus: approvedAppointments
                                    .elementAt(index)["status"]
                                    .toString(),
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => DetailsScreen(
                                        appointment: approvedAppointments
                                            .elementAt(index),
                                      ),
                                    ),
                                  );
