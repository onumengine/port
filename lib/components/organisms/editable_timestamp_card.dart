...
class EditableTimestampCard extends StatefulWidget {
  ...
  @override
  _EditableTimestampCardState createState() => _EditableTimestampCardState();
}

class _EditableTimestampCardState extends State<EditableTimestampCard> {
  bool dateIsEditable, timeIsEditable, durationIsEditable;
